...
const section1CounterCurrent = document.querySelector('.section1_bottom .counter_current');

let currentIndex1 = 0;
let currentIndex2 = 1;
let currentIndex3 = 2;
const renderSection1 = () => {
  block1Img.setAttribute('src', `${arrImg[currentIndex1].img}`);
  block2Img.setAttribute('src', `${arrImg[currentIndex2].img}`);
  block3Img.setAttribute('src', `${arrImg[currentIndex3].img}`);
  section1Title1.textContent = `${arrImg[currentIndex1].title}`;
  section1Title2.textContent = `${arrImg[currentIndex2].title}`;
  section1Title3.textContent = `${arrImg[currentIndex3].title}`;
  section1Country1.textContent = `${arrImg[currentIndex1].country}`;
  section1Country2.textContent = `${arrImg[currentIndex2].country}`;
  section1Country3.textContent = `${arrImg[currentIndex3].country}`;
  section1Info1.textContent = `${arrImg[currentIndex1].info}`;
  section1Info3.textContent = `${arrImg[currentIndex2].info}`;
  section1Info3.textContent = `${arrImg[currentIndex3].info}`;
  section1CounterCurrent.textContent = `${arrImg[currentIndex1].id}`;
};
